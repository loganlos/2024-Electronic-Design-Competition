...
build-1733561665: ../main.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccstheia141/ccs/utils/sysconfig_1.20.0/sysconfig_cli.bat" --script "C:/Users/LoganLos/workspace_ccstheia/Automatic_Driving/main.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_01_00_03/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-1733561665 ../main.syscfg
device.opt: build-1733561665
device.cmd.genlibs: build-1733561665
ti_msp_dl_config.c: build-1733561665
ti_msp_dl_config.h: build-1733561665
Event.dot: build-1733561665
